...
import numpy as np
from src.data_processing.process_data import read_image, read_label, normalize, resize_images
from src.data_processing.process_data import retrieve_mask_mappings, map_labels_tf, augment_image_and_label, load_dataset_unet
...
def test_load_dataset_unet(image_label):
    ...
    with patch('src.data_processing.load_data.get_datasets') as mock_get_datasets:
